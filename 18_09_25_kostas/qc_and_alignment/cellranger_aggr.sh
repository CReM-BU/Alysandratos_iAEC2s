...
script_name="cellranger_count_with_tdTomato"

echo "library_id,molecule_h5
B2,/restricted/projectnb/crem-bioinfo/project_workspace/18_09_25_kostas/calculations/cellranger_count_with_tdTomato_index_corrected/B2/outs/molecule_info.h5
C11,/restricted/projectnb/crem-bioinfo/project_workspace/18_09_25_kostas/calculations/cellranger_count_with_tdTomato_index_corrected/C11/outs/molecule_info.h5" > \
  /restricted/projectnb/crem-bioinfo/project_data/18_09_25_kostas/aggr.csv
...
name="aggregate_cellranger"
output_dir=$PW/calculations/$script_name/
# takes 40 minutes to run
num_cores=16
localmem=252
combined_metadata=/restricted/projectnb/crem-bioinfo/project_data/18_09_25_kostas/aggr.csv
